    ...
    <form method="POST" action="{{ route('seller.register') }}" class="space-y-5" x-data="{ loading: false, showPassword: false, showPasswordConfirmation: false }" @submit="loading = true">
        ...
        <div class="space-y-1.5">
            ...
            <input id="business_name" type="text" name="business_name" value="{{ old('business_name') }}" required
                   ...
                   class="w-full bg-white/70 border border-[#e6e9e2] rounded-xl py-3 px-4 text-gray-800 placeholder-gray-400 text-sm outline-none transition-all duration-200 focus:border-[#3f8a5c] focus:ring-2 focus:ring-[#3f8a5c]/20 @error('business_name') border-red-300 bg-red-50 @enderror">
        ...
        <div class="space-y-1.5">
            ...
            <input id="name" type="text" name="name" value="{{ old('name') }}" required placeholder="John Doe"
                   class="w-full bg-white/70 border border-[#e6e9e2] rounded-xl py-3 px-4 text-gray-800 placeholder-gray-400 text-sm outline-none transition-all duration-200 focus:border-[#3f8a5c] focus:ring-2 focus:ring-[#3f8a5c]/20 @error('name') border-red-300 bg-red-50 @enderror">
        ...
        <div class="space-y-1.5">
            ...
            <input id="phone" type="text" name="phone" value="{{ old('phone') }}" required placeholder="+880 1XXX-XXXXXX"
                   class="w-full bg-white/70 border border-[#e6e9e2] rounded-xl py-3 px-4 text-gray-800 placeholder-gray-400 text-sm outline-none transition-all duration-200 focus:border-[#3f8a5c] focus:ring-2 focus:ring-[#3f8a5c]/20 @error('phone') border-red-300 bg-red-50 @enderror">
        ...
        <div class="space-y-1.5">
            ...
            <textarea id="address" name="address" required placeholder="Your business address"
                      class="w-full bg-white/70 border border-[#e6e9e2] rounded-xl py-3 px-4 text-gray-800 placeholder-gray-400 text-sm outline-none transition-all duration-200 focus:border-[#3f8a5c] focus:ring-2 focus:ring-[#3f8a5c]/20 @error('address') border-red-300 bg-red-50 @enderror">{{ old('address') }}</textarea>
        ...
        <p class="text-center text-sm text-gray-400">
            Already a seller?
            <a href="{{ route('seller.login') }}" class="text-[#1f5c3f] hover:text-[#173d2b] font-medium transition-colors">Sign in</a>
        </p>
    </form>
@endsection
