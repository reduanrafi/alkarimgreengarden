    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="px-8 sm:px-12 py-8 sm:py-10 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                <a href="{{ route('checkout.create') }}" class="flex-1 py-3.5 bg-[#1f5c3f] text-white font-semibold rounded-xl hover:bg-[#173d2b] transition shadow-sm text-sm inline-flex items-center justify-center gap-2">
