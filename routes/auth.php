...
Route::middleware('guest')->group(function () {
    ...
    // Seller Auth
    Route::get('seller/register', [SellerAuthController::class, 'createRegister'])->name('seller.register');
    Route::post('seller/register', [SellerAuthController::class, 'storeRegister']);
    Route::get('seller/login', [SellerAuthController::class, 'createLogin'])->name('seller.login');
